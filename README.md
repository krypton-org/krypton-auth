...
GraphQL Auth Service provides an event bus notifying eventual errors. The `email-error` event is related to unset emails. The `error` event is related to any other kind of errors.
