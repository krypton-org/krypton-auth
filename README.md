...
A GraphQL API to handle login, registration, access control and password recovery with JSON Web Tokens. It automatically self-adapts [to your own user data model](https://github.com/JohannC/GraphQL-Auth-Service#verifyemailtemplate). [Try the live demo](https://graphql-auth-service.herokuapp.com/graphql). 
