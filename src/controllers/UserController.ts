...
export const checkEmailAvailable = async function (email: string): Promise<{ isAvailable: boolean }> {
    const emailExists = await User.userExists({ email })
    return { isAvailable: !emailExists };
};

export const checkUsernameAvailable = async function (username: string) {
    const usernameExists = await User.userExists({ username })
    return { isAvailable: !usernameExists };
};

export const confirmEmail = async function (req: any, res: any, next: any): Promise<void | never> {
...
export const createUser = async function (user: any, req: any): Promise<{ user: any, notifications: Notification[] } | never> {
    const notifications: Notification[] = [];
...
export const resendConfirmationEmail = async function (req: any): Promise<{ notifications: Notification[] } | never> {
    ensureLoggedIn(req);
    const notifications: Notification[] = [];
...
export const recoverPassword = async function (password: string, passwordRecoveryToken: string): Promise<{ notifications: Notification[] } | never> {
    let notifications = [];
...
export const updateUser = async function (userUpdates: any, req: any, res: any): Promise<{ user: any, notifications: Notification[] } | never> {
    ensureLoggedIn(req);
    let notifications = [];
...
export const deleteUser = async function (password: string, req: any): Promise<{ notifications: Notification[] } | never> {
    ensureLoggedIn(req);
    const notifications: Notification[] = [];
...
export const login = async function (login: string, password: string, res: any): Promise<{ token: string, user: any } | never> {
...
export const sendPasswordRecoveryEmail = async function (email: string, req: any): Promise<{ notifications: Notification[] } | never> {
    const notifications: Notification[] = [];
...
export const resetPasswordForm = function (req: any, res: any, next: any): void {
    const notifications: Notification[] = [];
    if (req.user) {
...
export const refreshToken = async function (req: any, res: any): Promise<{ token: string; expiryDate: Date; } | never> {
